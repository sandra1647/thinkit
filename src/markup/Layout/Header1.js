...
import logo from './../../images/thinkit-logo.png';
                        ...
                        <div className="container">
                            <div className="row d-flex justify-content-between">
                                <div className="dlab-topbar-left">
                                    <ul>
                                        <li><i className="flaticon-phone-call m-r5"></i> +381 (0) 60 0 300 518</li>
                                        <li><i className="ti-location-pin m-r5"></i>Teodora Drajzera 34, Beograd</li>
                                    </ul>
                                </div>
                                <div className="dlab-topbar-right">
                                    <ul>
                                        <li><i className="ti-email m-r5"></i> podrska@thinkit.rs</li>
                                        <li><i className="ti-email m-r5"></i> info@thinkit.rs</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="container clearfix">
                                ...
                                <div className="extra-nav">
                                    <div className="extra-cell">
                                        <Link to={'./contact'} className="dez-page site-button primary">POŠALJI UPIT </Link>
                                    </div>
                                </div>
