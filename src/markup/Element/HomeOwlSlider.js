					...
					<div className="slide-content overlay-primary">
						<div className="slide-content-box container">
							<div className="max-w600 text-white">
								<h2 className="text-white font-weight-400">POTREBNA VAM JE IT PODRŠKA? <br/></h2>
								<p>Potreban Vam je partner koji će Vas pratiti u tehnološkom razvoju?
										Za Vas možemo kreirati poslovne web aplikacije prilagođene 
										potrebama Vaše firme i tako ubrzati procese i do nekoliko puta!</p>
